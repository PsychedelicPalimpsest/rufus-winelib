...
/* TODO: There could be a more recent version for this, but I couldn't find it / get it working
 *       Based on the copyright notice, this could have a common origin to the nt_io.c file, 
 		 but I need to ask Pete about where he got it.
 */

#if defined(__linux__) || defined(_WINELIB)
